...
public/
  ...
  js/
    ...
    webmcp.js         ten WebMCP tools over the same state — invisible to the interface
scripts/
...
The interface is for a person with a mouse. Underneath it, the page registers **ten
